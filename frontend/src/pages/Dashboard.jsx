...
const Dashboard = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      onClick: async () => {
        try {
          // Resolve current user's email robustly. Prefer sessionStorage but fallback to an API call.
          ...
          if (!email) {
            try {
              ...
              console.warn("Could not fetch current user to resolve email", e);
            }
          }

          if (!email) {
            // Give up and go to create group page
